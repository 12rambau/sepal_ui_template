...
class DefaultExportTile(sw.Tile):
    ...
    def __init__(self, model, aoi_model, **kwargs):
        ...
        # define the model and the zoi_model as class attribute so that they can be manipulated in its custom methods
        self.model = model 
    ...
    def _export_to_asset(self, widget, event, data): 
        ...
        if not self.alert.check_input(self.io.dataset, cm.default_process.no_dataset): return
